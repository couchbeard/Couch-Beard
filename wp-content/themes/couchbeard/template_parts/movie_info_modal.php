<div id="myMovie" class="modal hide fade inverseback" tabindex="-1" role="dialog" aria-labelledby="myMovieLabel" aria-hidden="true">
	...
	<div class="modal-footer">
		<button class="btn btn-primary" id="play" data-loading-text="Playing" data-id=""><?php _e('Play', 'couchbeard'); ?></button>
	    <a href="#" class="btn" data-dismiss="modal" aria-hidden="true"><?php _e('Close', 'couchbeard'); ?></a>
	</div>
</div>