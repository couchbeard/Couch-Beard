  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="currentPlayingBox">
			...
			<div class="row-fluid">
				<div class="span5 pull-left">
					...
					<div class="span8">
						<div class="input-append">
							<input id="notificationfield" type="text" placeholder="<?php _e('Send notification', 'couchbeard'); ?>">
				...
				<div class="span3 pull-right">
					<label class="checkbox">
     					<input type="checkbox" id="ctrl"> <abbr title="<?php _e('Use arrow keys, backspace and enter buttons to control XBMC', 'couchbeard'); ?>"><?php _e('Control XBMC?' , 'couchbeard'); ?></abbr>
    				</label>
				</div>
			</div>
		</div>
		...
		<div id="xbmc_menu_button" class="muted"><?php _e('Current playing', 'couchbeard'); ?></div>
	</div>
    </div>
