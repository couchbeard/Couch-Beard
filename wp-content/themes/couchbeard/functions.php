...
function custom_scripts()
{
    ...
    wp_register_script('searchpage', get_template_directory_uri() . '/Scripts/searchpage.js', array('jquery', 'custom_script'));
...
function register_my_menus()
{
    register_nav_menus(array(
        'user'   => __('User menu', 'couchbeard'),
        'guest'     => __('Guest menu', 'couchbeard')
    ));
}
...
function custom_theme_setup()
{
    ...
    load_theme_textdomain('couchbeard', $lang_dir);
}
...
if (function_exists('register_sidebar')) {
    register_sidebar( array (
        'name' => __('Front footer 1', 'couchbeard'),
        'id' => 'front-footer-1',
    ...
    register_sidebar( array (
        'name' => __('Front footer 2', 'couchbeard'),
        'id' => 'front-footer-2',
    ...
    register_sidebar( array (
        'name' => __('Front footer 3', 'couchbeard'),
        'id' => 'front-footer-3',
        ...
        function end()
        {
            if ( ! $this->override() )
            {
                if ( false === file_put_contents( $this->cacheFile, ob_get_contents() . $this->cacheNotice ) )
                    echo "Trouble " . __LINE__; // Error message
