...
var err_title = "<?php _e('Not implemented', 'wpbootstrap'); ?>";
var err_msg = "<?php printf(__('<strong>%s</strong> was not added', 'wpbootstrap'), $data->Title); ?>";
var movie_error = "<?php _e('There was an error adding the movie. The movie was not added.', 'wpbootstrap'); ?>";
</script>